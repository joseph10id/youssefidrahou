			...
			<?php } ?>
				<div class="weblizar_fb-facebook-feed-top-area">
					<div class="weblizar_fb-facebook-feed-top-img ">
					 <!-- header link on logo --> 
						<a href="<?php if(isset($weblizar_header_data['link'])) { echo esc_url( $weblizar_header_data['link'] ); } else { echo "#";}?>" class="weblizar_fb-main-pic col-md-2 col-sm-2 col-xs-4">
							<!-- header logo image --> 
						...
						<div class="weblizar_fb-facebook-feed-top-info col-md-10 col-sm-10 ">
							...
							<div class="button-group col-md-4  text-center">
								<a type="button" target="_blank" class="weblizar_fb_btn_secondary pull-right feed_header_link" href="<?php if(isset($weblizar_header_data['link'])) { echo esc_url( $weblizar_header_data['link'] ); } else { echo "#";}?>"> <i class="fas fa-share"> </i>  <?php esc_html_e('Share', WEBLIZAR_FACEBOOK_TEXT_DOMAIN);?> </a>						
						    </div>
						</div>
					</div>
						<!-- Page link-->
								    ...
								    <?php if($comment !="")
										    ...
										    $comments=sizeof($comment);
											    ...
											    <div class="col-md-12 col-sm-12 col-xs-12 weblizar_fb-post-comment">
											     <!--comment curl url -->
												<?php $c_auther_url="https://graph.facebook.com/".esc_attr( $comment[$c]['id'] )."?access_token=".esc_attr( $token )."";
												   ...
												   <div class="col-md-1 col-sm-2 col-xs-2 weblizar_fb-post-comment-img">
													  	<a href="<?php echo "https://graph.facebook.com/".esc_attr( $c_auher1['from']['id'] );?>"><img src="https://graph.facebook.com/<?php echo esc_attr( $c_auher1['from']['id'] );?>/picture" class="fb_post_comment_img img-responsive" /></a>
												   </div>
												<?php } ?>
											        <!--comment author data -->
